...
abstract class $PaginationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int current, int total, int limit});
}
...
class _$PaginationModelImpl implements _PaginationModel {
  _$PaginationModelImpl({this.current = 1, this.total = 1, this.limit = 20});
  ...
  @override
  String toString() {
    return 'PaginationModel(current: $current, total: $total, limit: $limit)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, current, total, limit);
...
abstract class _PaginationModel implements PaginationModel {
  factory _PaginationModel(
      {final int current,
      final int total,
      final int limit}) = _$PaginationModelImpl;
